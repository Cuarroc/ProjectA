...
- `DiffView.tsx` (Hellmodus rendern und ansehen), Board-Karte (Zustandsformen), `TerminalView.tsx` (xterm-Farben aus der Tokenschicht), Tab-Hover-Beleg
...
- Diff > 300 Zeilen oder Nahtstelle = zwei unabhaengige Reviews mit
  Disposition in `.pa/review_w1-12_*.md`; sonst ein Reviewer ungleich Autor.
- Ein PR je Paket gegen `main`, CI gruen (gates linux/windows, red-first).

## Abschluss

Report `.pa/report_w1-12.md` (Belege, Gates, Review-Disposition), diese Datei
