...
- **Die geordnete Übersicht** aller offenen Pakete mit Status, Lane, Modell
  und Fortschritt steht in [`docs/MASTERPLAN.md`](../../docs/MASTERPLAN.md).
- **Erledigtes** steht in [`docs/ERLEDIGT.md`](../../docs/ERLEDIGT.md), neueste zuerst,
...
Startprompt: [`.pa/prompt_devflow.md`](../prompt_devflow.md). Keine
...
[`.pa/plan_projects_w5.md`](../plan_projects_w5.md) (Revision 3, vom Nutzer
...
| Ideen-Pipeline, Zeitachse, Vorschlags-Tab | nach W4, mit Kostenschätzung gegen den 50–100-€-Deckel |
